...
from model import AdvBacterialClassiferCNN
from trainer import BacterialTrainer
...
trainer = BacterialTrainer(model,train_loader,test_loader,optimizer,device=dev)
